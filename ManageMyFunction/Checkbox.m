...
- (void)drawRect:(CGRect)rect {
    ...
    if (_showTextLabel == YES) {
        ...
        if (_isChecked == YES) {
            ...
            [checkPath moveToPoint:CGPointMake(self.frame.size.width * 1/5, self.frame.size.height/4)];
            [checkPath addLineToPoint:CGPointMake(self.frame.size.width/10, self.frame.size.height * 4/5)];
            [checkPath addLineToPoint:CGPointMake(self.frame.size.width/15, self.frame.size.height/2)];
