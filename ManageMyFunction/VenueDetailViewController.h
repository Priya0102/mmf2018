...
#import "NIDropDown.h"
@interface VenueDetailViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,NIDropDownDelegate>
...
@property(nonatomic,retain)NSString *service_name_str,*loc_str,*city_str,*address_str,*capacity_str1,*capacity_str2,*service_id_str,*temprole_id,*area_idstr,*area_namestr,*venuetypeid_str,*city_idstr,*capacity_str,*venue_namestr,*areaid,*eventStr,*foodidstr;
