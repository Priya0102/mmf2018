...
#import "BookedTableViewCell.h"
#import "BookedOtherDetail.h"
#import "BookedFacility.h"
#import "BookedOtherDetailTableViewCell.h"
#import "RecieptViewController.h"
@interface BookedStatusViewController ()

@end

@implementation BookedStatusViewController
...
-(void)getOtherFacility{
    ...
    NSURLSessionDataTask *task=[sess dataTaskWithRequest:req completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        if (data==nil) {
            ...
            for(NSDictionary *temp in arr){
                BookedFacility *f=[[BookedFacility alloc]init];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView==self.tableview) {
        BookedTableViewCell *cell=[_tableview dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        
        BookedFacility *f=self.otherfaciltyarr[indexPath.row];
        ...
        BookedOtherDetailTableViewCell *cell=[_tableview2 dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        
        BookedOtherDetail *o=self.otherdetailarr[indexPath.row];
...
-(void)getOtherDetailsOfVenue{
    ...
    NSURLSessionDataTask *task=[sess dataTaskWithRequest:req completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        if (data==nil) {
            ...
            for(NSDictionary *temp in arr){
                BookedOtherDetail *o=[[BookedOtherDetail alloc]init];
