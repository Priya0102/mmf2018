...
@interface ReturnWalletViewController ()

@end

@implementation ReturnWalletViewController
...
-(void)submitChequePayment{
    ...
    NSString *myst=[NSString stringWithFormat:@"book_id=%@&payment_type_id=%d&transaction_id=%@&bank_name=%@",savedvalue,4,self.transactionId.text,self.banknameTxt.text];
