...
@interface VenueDetailTableViewCell : UITableViewCell
...
@property (strong, nonatomic) IBOutlet UIImageView *vegImg;

@property (strong, nonatomic) IBOutlet UIImageView *nonVegImg;
